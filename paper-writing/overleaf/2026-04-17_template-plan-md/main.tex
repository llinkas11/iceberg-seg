...
\textbf{Per-chip Otsu (OT).} A chip-adaptive threshold computed from the B08 histogram \citep{Otsu1979}, with guards on radiometrically flat or ice-contaminated chips (Otsu floor 0.10, ceiling 0.50; chip skipped if IC $>$ 15 \%). Provides an image-only adaptive baseline against which to measure the value of the fixed Fisser threshold under SZA shifts.
